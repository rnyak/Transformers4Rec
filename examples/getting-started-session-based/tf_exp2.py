...
schema = schema.select_by_name(['item_id_list_trim', 
                                'category_list_trim', 
...
export_tensorflow_ensemble(model, workflow, 'tf4rec', '/workspace/models/tf4rec/', ['session_id', 'day_first', 'item_id_count'])